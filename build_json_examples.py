...
examples_df = pd.read_csv('../exemples.xlsx')
examples_df.columns = [
    "code_ISIN", 
    "nom_du_produit", 
    "emetteur_du_produit", 
    ...
    "frais_ponctuels_sortie_anticipee", "frais_recurrents", "frais_accessoires", "performance_tension", "performance_maximale", "espérance_maximale_rendement"]
